...
--
-- Host: 127.0.0.1
-- Generation Time: Sep 02, 2025 at 08:40 AM
...
INSERT INTO `tblfaculty` (`id`, `userid`, `dateofjoining`, `designation`) VALUES
(94, 34, '2025-09-24', 'lecturer');
...
INSERT INTO `tblstudent` (`enro`, `userid`, `semesterid`, `divisionid`) VALUES
(23, 30, 2, 2),
(55, 35, 7, 1);
...
INSERT INTO `tbluser` (`id`, `departmentid`, `fname`, `lname`, `address`, `cityid`, `gender`, `dob`, `contact`, `emailid`, `password`) VALUES
(30, 1, 'df', 'fd', 'fdsfd', 10, 'f', '2025-09-10', 122357546, 'jenishjadav595@gmail.com', '123456'),
(32, 2, 'Jitu', 'Dayo', 'sda', 8, 'm', '2025-09-17', 342425343, 'ashishvaghasiya150@gmail.com', '321321'),
(34, 2, 'Sneha', 'Dayo', 'asd', 9, 'f', '2025-09-30', 24234221, 'dfjskj@gmail.com', '121212'),
(35, 2, 'Sangeeta', 'Jadav', 'fsd', 5, 'f', '2025-09-09', 3423524525, 'ckjdb@gmail.com', '1234567');
...
--
ALTER TABLE `tblstudent`
  MODIFY `enro` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2147483648;
