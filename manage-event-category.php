...
<body>
    <div class="dashboard-container">
        ...
        <main class="dashboard-content">
            ...
            <!-- Event Category Form -->
            <div class="card">
                <h3 id="formTitle">Add New Event Category</h3>
    ...
    <script>
        ...
        window.onload = function() {
            ...
            if (editId) {
                isEditMode = true;
                document.getElementById('pageTitle').textContent = 'Edit Event Category';
                document.getElementById('formTitle').textContent = 'Edit Event Category';
                document.getElementById('submitBtn').textContent = 'Update Category';
                
                // Load category data for editing (in real app, this would fetch from database)
        ...
        function loadCategoryData(id) {
            ...
            const categories = {
                '1': { name: 'Technical Events' },
                '2': { name: 'Cultural Events' },
                '3': { name: 'Sports Events' },
                '4': { name: 'Literary Events' }
            };
            
            if (categories[id]) {
                document.getElementById('categoryName').value = categories[id].name;
            }
        }
        ...
        document.getElementById('categoryForm').addEventListener('submit', function(e) {
            ...
            if (isEditMode) {
                ...
                alert('Event Category added successfully!');
            }
            
            window.location.href = 'admin-event-category.php';
        });
